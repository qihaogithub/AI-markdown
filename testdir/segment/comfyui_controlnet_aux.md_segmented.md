# ComfyUI's [to_be_replace[1]] Auxiliary Preprocessors
Plug-and-play [ComfyUI](https://github.com/comfyanonymous/ComfyUI) node sets for making [[to_be_replace[1]]](https://github.com/lllyasviel/[to_be_replace[1]]/) hint images

"anime style, a protest in the street, cyberpunk city, a woman with pink hair and golden eyes (looking at the viewer) is holding a sign with the text "ComfyUI [to_be_replace[1]] Aux" in bold, neon pink" on Flux.1 Dev

![](./examples/CNAuxBanner.jpg)

The code is copy-pasted from the respective folders in https://github.com/lllyasviel/[to_be_replace[1]]/tree/main/annotator and connected to [the 🤗 Hub](https://huggingface.co/lllyasviel/Annotators).
...
## Line Extractors
| Preprocessor Node           | sd-webui-controlnet/other |          [to_be_replace[1]]/T2I-Adapter           |
|-----------------------------|---------------------------|-------------------------------------------|
...
| MeshGraphormer Hand Refiner ([HandRefinder](https://github.com/wenquanlu/HandRefiner))  | depth_hand_refiner | [control_sd15_inpaint_depth_hand_fp16](https://huggingface.co/hr16/[to_be_replace[1]]-HandRefiner-pruned/blob/main/control_sd15_inpaint_depth_hand_fp16.safetensors) |
...
* hed:  [lllyasviel/Annotators/[to_be_replace[1]]HED.pth](https://huggingface.co/lllyasviel/Annotators/blob/main/[to_be_replace[1]]HED.pth)
...
* mesh_graphormer:  [hr16/[to_be_replace[1]]-HandRefiner-pruned/graphormer_hand_state_dict.bin](https://huggingface.co/hr16/[to_be_replace[1]]-HandRefiner-pruned/blob/main/graphormer_hand_state_dict.bin), [hr16/[to_be_replace[1]]-HandRefiner-pruned/hrnetv2_w64_imagenet_pretrained.pth](https://huggingface.co/hr16/[to_be_replace[1]]-HandRefiner-pruned/blob/main/hrnetv2_w64_imagenet_pretrained.pth)
